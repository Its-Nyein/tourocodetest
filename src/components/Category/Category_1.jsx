...
import Image1 from "../../assets/images/category_1.jpg";
import Image2 from "../../assets/images/category_2.jpg";
import Image3 from "../../assets/images/category_3.jpg";
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 p-5 items-center justify-center">
          <div className="rounded-2xl relative h-[350px] flex flex-col shadow-lg">
            ...
            <div className="flex items-center justify-between mt-2">
              <h1 className="font-semibold pl-2 text-lg">GOA Beach</h1>
          ...
          <div className="rounded-2xl relative h-[350px] flex flex-col shadow-lg">
            ...
            <div className="flex items-center justify-between mt-2">
              <h1 className="font-semibold pl-2 text-lg">South Beach</h1>
              <p className="flex mr-2 items-center text-[#ea580c]">
                <FaStar className="mr-2" />
                <span className="tracking-wider font-semibold text-lg">
                  4.7
            ...
            <div className="flex items-center mt-3 pl-2">
              <IoLocationOutline className="text-2xl text-[#0369a1] mr-2" />
              <span className="text-base font-semibold">Miami</span>
            </div>
          </div>
          ...
          <div className="rounded-2xl relative h-[350px] flex flex-col shadow-lg">
            ...
            <div className="flex items-center justify-between mt-2">
              <h1 className="font-semibold pl-2 text-lg">Maya Bay</h1>
              <p className="flex mr-2 items-center text-[#ea580c]">
                <FaStar className="mr-2" />
                <span className="tracking-wider font-semibold text-lg">
                  4.3
            ...
            <div className="flex items-center mt-3 pl-2">
              <IoLocationOutline className="text-2xl text-[#0369a1] mr-2" />
              <span className="text-base font-semibold">Thailand</span>
            </div>
          </div>
        </div>
      </div>
